...
"<button onclick=\"del("+response.data[i].mid+")\" style=\"height: 32px;font-size: 17px;background-color: #9CE6AD;border: 50px;color: #333;padding: 4px 9px;border-radius: 5px;\">"+
"删除</button></h1>"+
"<br>"+
...
function del(mid1) {
    $.get("http://127.0.0.1/scholat/php/download.php", {
        mid:mid1
