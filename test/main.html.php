...
<script type="text/javascript" src="../js/total_main.js"></script>
...
<a class="f-fcgreen" href="/u/mooc78989191435339617" target="_blank">      </a>
</h5>
</div>
...
$.get(adir+"consql_finename.php", {
            ...
            $('#welname').html("欢迎您,"+response.data[0].username);
