...
$sql = "SELECT material.mid,material.mtype,material.`name`,material.type,material.download,teacher.`name` as tname,material.size,material.uploadtime FROM material INNER JOIN teacher ON material.tid = teacher.tid";  
