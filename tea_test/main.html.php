<html xmlns="//www.w3.org/1999/xhtml" xml:lang="zh" lang="zh" class="windows desktop landscape">

<head>
  <title>软件项目管理</title>
  <meta http-equiv="content-type" content="text/html;charset=utf-8">
  <link rel="shortcut icon"
    href="//edu-image.nosdn.127.net/32a8dd2a-b9aa-4ec9-abd5-66cd8751befb.png?imageView&amp;quality=100">
  ...
  <script src="../public/js/layui.all.min.js"></script>
  <script src="../js/config.js"></script>

 <!-- <script src="https://cdn.bootcdn.net/ajax/libs/layui/2.4.5/layui.all.js"></script> -->
      ...
      <div class="f-cb">
        ...
        <div class="f-fl info">
          ...
          <h5 class="f-fc6 padding-top-5">
            <a class="f-fcgreen" href="tea_team.html" target="_blank"> 教学团队 </a>
          </h5>

        </div>

        <div class="f-fr comment" style="border-top-width: 0px;">
          <div id="welname" style="float: left;margin-right: 39px;margin-top: 10px;">
            <p>欢迎您,教师</p>
          </div>
          <div class="comment_link" style="float: right;" id="j-comment-link"><a href="../index.html">退出登录</a>
          </div>
    ...
    <div class="g-wrap f-cb">
      <div class="g-sd1" style="position:absolute; position:fixed;">
        <div class="m-learnleft">
          <div class="top f-pr">
            <img class="" id=""
              src="https://edu-image.nosdn.127.net/1D86CCF8C169C5F824A3876E7FE5EAA3.jpg?imageView&amp;thumbnail=510y288&amp;quality=100"
              width="230" height="130" alt="软件项目管理">
          ...
          <ul id="j-courseTabList" class="tab u-tabul">
            <li class="u-greentab j-tabitem f-f0  u-curtab" onclick="btn(this)" data-name="公告" data-type="1"
              data-id="1208734419" id="btnmain1">
              <a class="f-thide f-fc3" href="#/learn/announce">公告</a>
            </li>
            <li class="u-greentab j-tabitem f-f0" onclick="btn(this)" data-name="教学大纲" data-type="2"
              data-id="1208734420" id="btnmain2">
              <a class="f-thide f-fc3" id="grandsd" href="#/learn/score">教学大纲</a>
            </li>
            <li class="u-greentab j-tabitem f-f0" onclick="btn(this)" data-name="课件" data-type="3" data-id="1208734421"
              id="btnmain3">
              <a class="f-thide f-fc3" href="#/learn/content">课件</a>
            </li>
            <li class="u-greentab j-tabitem f-f0" onclick="btn(this)" data-name="作业" data-type="4" data-id="1208734422"
              id="btnmain4">
              <a class="f-thide f-fc3" href="#/learn/testlist">作业</a>
            </li>
            <li class="u-greentab j-tabitem f-f0" onclick="btn(this)" data-name="班级" data-type="5" data-id="1208734423"
              id="btnmain5">
              <a class="f-thide f-fc3" href="#/learn/examlist">班级</a>
            </li>
            <li class="u-greentab j-tabitem f-f0 last" onclick="btn(this)" data-name="讨论区" data-type="6"
              data-id="1208734424" id="btnmain6">
          ...
          <div class="m-coulshar f-bg f-cb" id="j-courseshare">
            <div id="j-coushare">
              ...
              <div class="u-share f-cb"> <a class="weixin f-fl f-fc6 solo f-icon u-icon-weixin f-pr" title="分享到微信"
                  rel="weixin" id="auto-id-1554020821414">
                  <div class="cnt f-f0 f-pa f-dn"> <img
                      src="http://edu-image.nosdn.127.net/_PhotoUploadUtils_ffae7f67-fe3d-445e-b13e-d57c1d6bdc28.png"
                      class="j-pic" width="125">
                    <div class="tip">用微信扫描二维码<br>分享至好友和朋友圈</div>
                    <div class="tipBg f-pa"></div>
                    <div class="tipTp f-pa"></div>
                  </div>
                </a> <a class="solo f-fl f-fc6 sina f-icon u-icon-weibo" title="分享到新浪微博" rel="sina"
                  id="auto-id-1554020821416"></a> <a class="solo f-fl f-fc6 qzone f-icon u-icon-qq" title="分享到QQ空间"
                  rel="qzone" id="auto-id-1554020821418"></a> <a class="solo f-fl f-fc6 renren f-icon u-icon-renren"
                  title="分享到人人" rel="renren" id="auto-id-1554020821420" style="display: none;"></a> </div>
            </div>
            <div class="noticeShare f-pr j-noticeShare f-f0" style="display:none">
              <p>现在分享好课有奖哦~</p>
              <p class="btns"><span class="detail" id="j-activityDetail">查看活动详情</span><span
                  id="j-ignoreActivityNotice">忽略</span></p>
